# # why is nothing stopping me from doing this lol
# def set_property_for_pickled(prop, prop_name, attach_to):
#     attach_to.globals = globals
#     attach_to.globals()[prop_name] = prop

# params.load("results/data/hacked_fitness_fm_supersimple_only_tt_precion_generalization_both_01-11-2022_17-57-32/supersimple_generalization/2_01-11-2022_17-57-32/2_01-11-2022_17-57-32_params.json")
# params.t_exec_scoring_weight = [1, 20]
# set_property_for_pickled(params, "params", fitnesscalc)
# set_property_for_pickled(innovs, "innovs", best_g)
# set_property_for_pickled([1,2,3], "tasks", best_g.globals()["innovs"])

####
# # monkey patch once more bc import is broken
# from pm4py.algo.simulation.playout.petri_net import algorithm as simulator
# from pm4py.algo.evaluation import earth_mover_distance
# from src.tests.monkeypatch import pyemd_mp
# earth_mover_distance.variants = pyemd_mp

# language = variants_module.get_language(spliced_log)

# model_language = simulator.apply(net, im, fm, variant=simulator.Variants.STOCHASTIC_PLAYOUT)
